...
```bash
sudo wget -O newt_installer.sh "https://raw.githubusercontent.com/goodguygreat/newt_installer/refs/heads/main/newt_installer.sh" && sudo chmod +x ./newt_installer.sh
```
